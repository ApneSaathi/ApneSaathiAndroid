...
class Emergency_Contact_Activity : BaseActivity<EmergencyContact_ViewModel>() {
    val titleHospital="Hospital's Contact"
    val titlePoliceStation="Police Station's"
    val titleApneSathiConsulatant="Apne Sathi Consulatant's"
    val titleCustomContact="Custom Contact's"
